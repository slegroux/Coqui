...
from TTS.tts.datasets.formatters import common_voice, spgispeech
...
class TestTTSFormatters(unittest.TestCase):
    ...
    def test_spgispeech(self):  # pylint: disable=no-self-use
        # items = spgispeech(split='test')
        ...
        items = spgispeech(split='validation')
